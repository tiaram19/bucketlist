...
client = MongoClient('mongodb+srv://lxtiara:admin@cluster0.zhgzgvs.mongodb.net/?retryWrites=true&w=majority')
db = client.dbsparta
...
def bucket_done():
   ...
   return jsonify({'msg': 'Selamat! Semangat membuat list baru^^'})
